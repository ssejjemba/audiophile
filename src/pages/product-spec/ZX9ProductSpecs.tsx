    ...
    <>
      ...
      <SpecsMainContainer>
        ...
        <GadgetSection>
          <GadgetCard
            GadgetName={
              gadgetData.speakersCategory.speakers.ZX9Speakers.gadgetName
            }
            GadgetDetails={
              gadgetData.speakersCategory.speakers.ZX9Speakers.gadgetDetails
            }
            Src={
              gadgetData.speakersCategory.speakers.ZX9Speakers.gadgetImageURL
            }
            Alt={
              gadgetData.speakersCategory.speakers.ZX9Speakers.gadgetImageAlt
            }
            IsNewLabel={
              gadgetData.speakersCategory.speakers.ZX9Speakers.IsNewGadgetLabel
            }
            IsCardEven={
              gadgetData.speakersCategory.speakers.ZX9Speakers.IsEvenCard
            }
            GadgetPrice={
        ...
        <Feature
          paragraph1={
            gadgetData.speakersCategory.speakers.ZX9Speakers["feature-para-1"]
          }
          paragraph2={
            gadgetData.speakersCategory.speakers.ZX9Speakers["feature-para-2"]
          }
        />
        <Gallery
          sideTopURL={
            gadgetData.speakersCategory.speakers.ZX9Speakers.gadgetGallery
              .sideTopImg.ImageUrl
          }
          sideTopAlt={
            gadgetData.speakersCategory.speakers.ZX9Speakers.gadgetGallery
        ...
        <RelatedProductsSection>
          ...
          <RelatedProductsCardContainer>
            {Object.values(
              gadgetData.speakersCategory.speakers.ZX9Speakers
                .otherRelatedProduct
            ).map((cardData) => (
              <OtherProductCard
